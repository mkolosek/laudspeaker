...
fetch("https://laudspeaker-api.ruby.ci/events/batch", requestOptions)
...
axios.post("https://laudspeaker-api.ruby.ci/events/batch", {
  "batch": [
    {
      "timestamp": "` +
        timestamp +
...
`
    ...
    case SnippetMode.CURL:
      return (
        `curl -X POST \
https://laudspeaker-api.ruby.ci/events/batch \
